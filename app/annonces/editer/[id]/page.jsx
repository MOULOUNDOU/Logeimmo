...
import { updateAnnonce } from '@/lib/supabase/annonces'
...
function EditerAnnoncePage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (annonce.createdBy !== authData?.user?.id && authData?.user?.role !== 'admin') {
        router.push('/dashboard-courtier')
        return
      }
      ...
      setFormData({
        ...
        superficie: annonce.superficie?.toString() || '',
        adresse: annonce.adresse || '',
        ville: annonce.ville || 'Dakar',
        quartier: annonce.quartier || '',
        chambres: annonce.chambres?.toString() || '1',
        sallesDeBain: annonce.sallesDeBain?.toString() || '1',
        meuble: annonce.meuble || false,
        latitude: annonce.latitude?.toString() || '',
        longitude: annonce.longitude?.toString() || ''
      })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(error.message || 'Erreur lors de la modification de l\'annonce')
    } finally {
          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
            <div className="max-w-4xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8 space-y-6">
                {/* Même formulaire que publier/page.jsx */}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-primary-100 hover:bg-primary-200 text-primary-700 rounded-lg transition-colors font-medium disabled:opacity-50 flex items-center gap-2"
                      >
                ...
                <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-primary-500 hover:bg-primary-600 text-gray-900 rounded-lg transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
...
export default EditerAnnoncePage
